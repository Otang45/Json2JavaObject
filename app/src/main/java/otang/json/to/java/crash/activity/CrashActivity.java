package otang.json.to.java.crash.activity;
...
import otang.json.to.java.crash.config.CrashConfig;

public final class CrashActivity {

	private final static String TAG = "CrashActivity";
	//Extras passed to the error activity
	private static final String EXTRA_CONFIG = "otang.json.to.java.EXTRA_CONFIG";
	private static final String EXTRA_STACK_TRACE = "otang.json.to.java.EXTRA_STACK_TRACE";
	private static final String EXTRA_ACTIVITY_LOG = "otang.json.to.java.EXTRA_ACTIVITY_LOG";
	//General constants
	private static final String INTENT_ACTION_ERROR_ACTIVITY = "otang.json.to.java.ERROR";
	private static final String INTENT_ACTION_RESTART_ACTIVITY = "otang.json.to.java.RESTART";
	private static final String CRASH_HANDLER_PACKAGE_NAME = "otang.json.to.java.";
	private static final String DEFAULT_HANDLER_PACKAGE_NAME = "com.android.internal.os";
	private static final int MAX_STACK_TRACE_SIZE = 131071; //128 KB - 1
	private static final int MAX_ACTIVITIES_IN_LOG = 50;
	//Shared preferences
	private static final String SHARED_PREFERENCES_FILE = "otang.json.to.java_preferences";
